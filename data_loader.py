...
class DataLoader:
    ...
    def __init__(self, data):
        ...
        df_rating = pd.read_csv(self.cfg[data]['rating_path'], sep=self.cfg[data]['rating_sep'], names=['userID', 'itemID', 'rating'], usecols=[0,1,2], skiprows=1)

        # print(df_rating['userID'])
        # print(df_rating['itemID'])
